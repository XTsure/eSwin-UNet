...
class UpSamplingBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=2, stride=2, padding=0, bias=True,feature_size=224):
    ...
    def forward(self, x, concat_feature):
        ...
        return torch.cat((self.vit(concat_feature), tran_conv_out), dim=1)


class ViTInSkipConnectionUNet(nn.Module):
    '''UNet 网络架构
    lr 0.001
    '''
