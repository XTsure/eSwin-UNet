...
class VibUNet(nn.Module):
    ...
    def __init__(self, img_size, img_channel, class_num):
        ...
        self.vit_block = ViT(image_size=14, patch_num=7, dim=2048, depth=3, heads=12, mlp_dim=4096, dropout=0.1,
                             emb_dropout=0.1, channels=512)
    ...
    def forward(self, x):
        ...
        vit_out = self.vit_block(conv_block_out_5)

        conv_block_out_6 = self.conv_block_6(self.up_sampling_1(vit_out, conv_block_out_4))
