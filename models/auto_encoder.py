...
class AutoEncoder(nn.Module):
    ...
    def __init__(self, img_channel):
        ...
        self.conv_block_4 = DoubleConvBlock(128, 64)
        self.up_sampling_2 = UpSamplingBlock(64, 32)
        self.conv_block_5 = DoubleConvBlock(64, 32)
        self.out = nn.Conv2d(32, img_channel, 1)
    ...
    def forward(self, x):
        ...
        conv_block_out_4 = self.conv_block_4(self.up_sampling_1(conv_block_out_3, conv_block_out_2))
        conv_block_out_5 = self.conv_block_5(self.up_sampling_2(conv_block_out_4, conv_block_out_1))

        out = self.out(conv_block_out_5)
